...
printf '%s\n' 'DEPLOY_GO_EVENT {"schema_version":1,"event":"deploy.step.started","module":"postgres","step_id":"postgres.package","step":"打包 Compose 配置"}'
printf '%s\n' 'DEPLOY_GO_EVENT {"schema_version":1,"event":"deploy.step.succeeded","module":"postgres","step_id":"postgres.package","step":"打包 Compose 配置"}'
