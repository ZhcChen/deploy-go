...
assert_contains "$CAPTURE_DIR/install.env.0" 'DEPLOY_GO_AGENT_PROTOCOL_VERSION=4'
...
assert_contains "$DEPLOY_SCRIPT" 'protocol:{minimum:$protocol_minimum,maximum:$protocol_maximum}'
