...
- `https://deploy.example.com/api/v1/agent/download/0_3_1/manifest.json`
- `https://deploy.example.com/api/v1/agent/download/0_3_1/agent/x86_64`
- `https://deploy.example.com/api/v1/agent/download/0_3_1/agent/aarch64`
- `https://deploy.example.com/api/v1/agent/download/0_3_1/executor/x86_64`
- `https://deploy.example.com/api/v1/agent/download/0_3_1/executor/aarch64`
- `https://deploy.example.com/api/v1/agent/download/0_3_1/systemd-unit/agent`
- `https://deploy.example.com/api/v1/agent/download/0_3_1/systemd-unit/executor`
- `https://deploy.example.com/api/v1/agent/download/0_3_1/executor-config`

版本路径使用下划线形式，同时也接受点分版本 `0.3.1`。安装器仍先下载 manifest，再按架构下载二进制并校验 SHA-256，不再依赖 GitHub Release 作为节点下载源。
