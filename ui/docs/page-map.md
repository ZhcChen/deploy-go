...
| `#/web/settings` | 系统设置 | 部署默认值、用户和审计入口，仅管理员可见 |
...
“我的”固定占用一级导航，承载账号身份、权限范围、个人资料、偏好和退出入口，为账号体系提供稳定入口。
...
| `#/app/mine` | 我的 | 账号身份、权限范围、个人资料和设置入口 |
| `#/app/mine/role` | 权限说明 | 唯一管理员身份、资源范围和权限明细 |
