...
class SettingsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RuntimeSettings] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RuntimeSettings>> settingsShow({
    ...
    RuntimeSettings? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RuntimeSettings),
      ) as RuntimeSettings;
    ...
    return Response<RuntimeSettings>(
      data: _responseData,
