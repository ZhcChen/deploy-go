...
class AgentsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AgentEnrollmentResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgentEnrollmentResponse>> agentsCreate({
    ...
    AgentEnrollmentResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AgentEnrollmentResponse),
    ...
    return Response<AgentEnrollmentResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AgentInstallCommandResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgentInstallCommandResponse>> agentsCreateInstallCommand({
    ...
    final _path = r'/api/v1/agents/{agent_id}/install-command'.replaceAll('{' r'agent_id' '}', encodeQueryParameter(_serializers, agentId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'X-CSRF-Token': xCSRFToken,
    ...
    AgentInstallCommandResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AgentInstallCommandResponse),
      ) as AgentInstallCommandResponse;
    ...
    return Response<AgentInstallCommandResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgentListResponse>> agentsList({
    int? limit,
    String? after,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> agentsRevoke({
    required String agentId,
    required String xCSRFToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/agents/{agent_id}/revoke'.replaceAll('{' r'agent_id' '}', encodeQueryParameter(_serializers, agentId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'X-CSRF-Token': xCSRFToken,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgentResponse>> agentsShow({
    required String agentId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/agents/{agent_id}'.replaceAll('{' r'agent_id' '}', encodeQueryParameter(_serializers, agentId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
