...
class AuthApi {
  ...
  Future<Response<SessionResponse>> authLogin({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserIdentity>> authMe({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserPreferencesResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPreferencesResponse>> authPreferences({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/preferences';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    UserPreferencesResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserPreferencesResponse),
  ...
  /// Returns a [Future] containing a [Response] with a [UserIdentity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserIdentity>> authProfile({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CsrfTokenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CsrfTokenResponse>> authRefreshCsrf({
    required String origin,
    required String secFetchSite,
    required String secFetchMode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/csrf';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Origin': origin,
        r'Sec-Fetch-Site': secFetchSite,
        r'Sec-Fetch-Mode': secFetchMode,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[
    ...
    CsrfTokenResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CsrfTokenResponse),
    ...
    return Response<CsrfTokenResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserIdentity>> authSetup({
    ...
    try {
      const _type = FullType(SetupRequest);
      _bodyData = _serializers.serialize(setupRequest, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SetupStatusResponse>> authSetupStatus({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [UserPreferencesResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPreferencesResponse>> authUpdatePreferences({
    required String xCSRFToken,
    required UpdateUserPreferencesRequest updateUserPreferencesRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateUserPreferencesRequest);
      _bodyData = _serializers.serialize(updateUserPreferencesRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [UserIdentity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserIdentity>> authUpdateProfile({
    required String xCSRFToken,
