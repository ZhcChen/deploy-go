...
class AuditApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AuditLogListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuditLogListResponse>> auditList({
    int? limit,
    String? after,
    String? action,
    String? resourceType,
    ...
    AuditLogListResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuditLogListResponse),
