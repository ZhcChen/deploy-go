...
class UsersApi {
  ...
  Future<Response<UserResponse>> usersCreate({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserListResponse>> usersList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> usersResetPassword({
    required String id,
    required String xCSRFToken,
    ...
    final _path = r'/api/v1/users/{id}/password'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'X-CSRF-Token': xCSRFToken,
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> usersShow({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> usersUpdateStatus({
    required String id,
    required String xCSRFToken,
    required UpdateStatusRequest updateStatusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/users/{id}/status'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        r'X-CSRF-Token': xCSRFToken,
    ...
    try {
      const _type = FullType(UpdateStatusRequest);
      _bodyData = _serializers.serialize(updateStatusRequest, specifiedType: _type);
