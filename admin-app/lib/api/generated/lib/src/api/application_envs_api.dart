...
class ApplicationEnvsApi {
  ...
  /// applicationEnvsFetchSecretLease
  ///
  ///
  /// Parameters:
  /// * [leaseId]
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<int>>> applicationEnvsFetchSecretLease({
    ...
    final _path = r'/api/v1/agent/application-env-leases/{lease_id}'.replaceAll('{' r'lease_id' '}', encodeQueryParameter(_serializers, leaseId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RetryApplicationEnvSyncResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RetryApplicationEnvSyncResponse>> applicationEnvsRetrySync({
    ...
    final _path = r'/api/v1/application-env-files/{env_file_id}/sync-retry'.replaceAll('{' r'env_file_id' '}', encodeQueryParameter(_serializers, envFileId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'X-CSRF-Token': xCSRFToken,
    ...
    RetryApplicationEnvSyncResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RetryApplicationEnvSyncResponse),
      ) as RetryApplicationEnvSyncResponse;
    ...
    return Response<RetryApplicationEnvSyncResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
