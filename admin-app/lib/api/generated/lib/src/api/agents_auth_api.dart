...
class AgentsAuthApi {
  ...
  const AgentsAuthApi(this._dio, this._serializers);
  ...
  Future<Response<TokenPairResponse>> agentEnroll({
    required EnrollRequest enrollRequest,
    ...
    final _path = r'/api/v1/agent/enroll';
    ...
    try {
      const _type = FullType(EnrollRequest);
      _bodyData = _serializers.serialize(enrollRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TokenPairResponse),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RefreshTokenPairResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RefreshTokenPairResponse>> agentRefresh({
    ...
    final _path = r'/api/v1/agent/refresh';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RefreshTokenPairResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RefreshTokenPairResponse),
      ) as RefreshTokenPairResponse;
    ...
    return Response<RefreshTokenPairResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
