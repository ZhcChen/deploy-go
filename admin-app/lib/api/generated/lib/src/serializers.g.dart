...
Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(BindCredentialRequest.serializer)
      ..add(ConfirmHostKeyRequest.serializer)
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ApplicationGrantResponse)]),
          () => ListBuilder<ApplicationGrantResponse>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ApplicationResponse)]),
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(DeploymentResponse)]),
          () => ListBuilder<DeploymentResponse>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(DeploymentTargetResponse)]),
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(SecretFileReference)]),
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(SshCredentialResponse)]),
