...
test -x "$release_root/0.3.1/deploy-go-agent-linux-x86_64"
test -x "$release_root/0.3.1/deploy-go-agent-linux-aarch64"
test -x "$release_root/0.3.1/deploy-go-agent-executor-linux-x86_64"
test -x "$release_root/0.3.1/deploy-go-agent-executor-linux-aarch64"
test -f "$release_root/0.3.1/deploy-go-agent-manifest.json"
test -f "$release_root/0.3.1/deploy-go-agent.service"
test -f "$release_root/0.3.1/deploy-go-agent-runner.service"
test -f "$release_root/0.3.1/deploy-go-agent-executor.service"
test -f "$release_root/0.3.1/executor.json.in"
jq -e '.agent_version == "0.3.1"' \
  "$release_root/0.3.1/deploy-go-agent-manifest.json" >/dev/null
