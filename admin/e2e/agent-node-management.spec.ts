...
const agent = { id: "agent-1", node_id: "node-1", name: "生产 Agent", status: "online", agent_version: "0.3.4", hostname: "prod-01", architecture: "x86_64", created_at: "2026-08-01T00:00:00Z" };
...
test("管理员通过节点协同程序执行能力检查", async ({ page }) => {
  ...
  await expect(page.getByText("v0.3.4")).toBeVisible();
