...
const agent = { id: "agent-1", node_id: "node-1", name: "生产 Agent", status: "online", agent_version: "0.3.1", hostname: "prod-01", architecture: "x86_64", created_at: "2026-08-01T00:00:00Z" };
