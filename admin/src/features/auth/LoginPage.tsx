  ...
  return (
    <AuthLayout context="部署控制服务">
      ...
      <form className="auth-form" onSubmit={submit}>
        <Field label="账号或邮箱"><TextInput name="username" autoComplete="username" required autoFocus /></Field>
        <Field label="密码"><TextInput name="password" type="password" autoComplete="current-password" required /></Field>
