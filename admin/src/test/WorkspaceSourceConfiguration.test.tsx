...
const agent = { id: "agent-1", name: "Build Agent", node_id: "node-1", environment: "测试", status: "online", protocol_version: 14, agent_version: "0.3.0", created_at: "2026-09-03T00:00:00Z" };
...
describe("本地工作区来源配置", () => {
  it("未配置时只显示开始按钮，管理员保存后进入已配置状态", async () => {
    ...
    await user.click(await screen.findByRole("option", { name: /Build Agent · v0\.3\.0/ }));
