...
const agent = { id: "agent-1", name: "Build Agent", node_id: "node-1", environment: "测试", status: "online", protocol_version: 14, agent_version: "0.3.4", created_at: "2026-09-03T00:00:00Z" };
