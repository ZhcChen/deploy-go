...
check: api-check agent-install-check agent-manifest-check agent-release-sync-check deploy-production-check ui-check api-client-check admin-check admin-app-check client-sensitive-check ## 执行全仓检查
